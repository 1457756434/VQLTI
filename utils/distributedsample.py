...
class WeightedRandomSampler(Sampler[int]):
    ...
    def __init__(self, dataset: Dataset, weights: Sequence[float], num_samples: int, num_replicas: int, rank: int,
                 replacement: bool = True, generator=None, drop_last: bool = False) -> None:
