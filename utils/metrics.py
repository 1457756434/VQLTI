...
class Metrics(object):
    ...
    def MAE_new(self, pred, gt, data_mask, clim_time_mean_daily, data_std):
        """
        MAE metric.
    ...
    def Accuracy(self, pred, gt, data_mask, clim_time_mean_daily, data_std):
            """
            MAE metric.
            ...
            acc = sum([1 for x,y in zip(pred_index, gt) if x==y]) / len(pred_index)
            return acc
